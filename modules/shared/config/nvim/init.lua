...
require('lazy').setup({
...

  {
    ...
    cmd = 'Neotree',
    keys = {
      { '<leader>n', '<Cmd>Neotree filesystem reveal right toggle<CR>', desc = 'Toggle [N]eoTree' },
      { '<leader>b', '<Cmd>Neotree buffers reveal right toggle<CR>', desc = 'Toggle NeoTree [Buffer]' },
    },
    opts = {
