# Generated by Powerlevel10k configuration wizard on 2024-01-08 at 21:00 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#89DCEB'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#94E2D5'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#A6E3A1'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND='#94E2D5'
  ...
  #[ nix_shell: nix shell (https://nixos.org/nixos/nix-pills/developing-with-nix-shell.html) ]##
  # Nix shell color.
  typeset -g POWERLEVEL9K_NIX_SHELL_FOREGROUND='#89B4FA'
